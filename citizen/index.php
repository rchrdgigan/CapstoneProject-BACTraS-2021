<?php           
    ...
    $authenCitizen = New Citizen();
    $authenCitizen->authCitizen(); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <i class="fa fa-envelope" aria-hidden="true" style="font-size: 15px;">
                    </i>Contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="about.php">
                    <i class="fa fa-users" aria-hidden="true" style="font-size: 15px;">
                    </i>About Us</a>
                </li>
        ...
        <div class="col-md-8">
            <div class="card mb-3 qrcode-card">
                    ...
                    <div class="page print mb-4" id="downloadqr">
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-md-4 text-center">
                                <?php
                                    $username=$_SESSION['citizenUsername'];
                                    $role=$_SESSION['role'];
                                    $displayCitizeninfo = New Citizen();
                                    $displayCitizeninfo->getidCitizen($username, $role);
                                ?>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <button id="btnprnt" type="submit" class="no-print btn btn-primary">Print</button>
                </div>       
            </div>
        </div>
    </div>
