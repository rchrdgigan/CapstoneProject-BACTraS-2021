                    ...
                    <div class="card-body">
                        <form method="POST" action="admin.php">
                            <?php 
                                if (isset($_POST['submit'])) {
                                    ...
                                    if (strlen($password) < 6) {
                                        ...
                                        $testObject = new Admin();
                                        $testObject->loginAdmin($username, $password);
                                    }
                                }
                            ?>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="username" class="form-control" name="username" autocomplete="username" autofocus required>
                                </div>
                            </div>
                            <div class="form-group row">
