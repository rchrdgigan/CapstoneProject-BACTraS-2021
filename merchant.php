<?php include('classes/dbcon.class.php');
...
<div class="container" id="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-5 mb-5">
            <div class="card">
                <div class="card-header">Establishment Login</div>
                <div class="card-body">
                    <?php
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (strlen($password) < 6) {
                            ...
                            $loginEstablishment = New Establishment();
                            $loginEstablishment -> loginEstablishment($username,$password);
                            }
                        }
                    ?>
