                                ...
                                <div class="module-body">
                                    <?php
                                        if (isset($_POST['submit'])) {
                                            ...
                                            $password = password_hash($haspassword, PASSWORD_DEFAULT);
                                            $role = "Person";
                                            $insertCitizen = New Admin();
                                            $insertCitizen -> insertCitizen($fname, $mname, $lname, $suffix, $bdate, $address, $gender, $cpnumber,$username, $password, $role);
                                        }
                                    ?>
                                    <form class="form-horizontal row-fluid" method="POST" action="registrationCitizen.php">
